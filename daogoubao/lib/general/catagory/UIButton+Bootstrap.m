...
-(void)bootstrapStyle{
    ...
    [self.titleLabel setFont:[UIFont fontWithName:@"ArialMT" size:self.titleLabel.font.pointSize]];
}
...
-(void)defaultStyle{
    ...
    [self setBackgroundImage:[UIColor createImageWithColor:[UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)primaryStyle{
    ...
    [self setBackgroundImage:[UIColor createImageWithColor:[UIColor colorWithRed:51/255.0 green:119/255.0 blue:172/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)successStyle{
    ...
    [self setBackgroundImage:[UIColor createImageWithColor:[UIColor colorWithRed:69/255.0 green:164/255.0 blue:84/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)infoStyle{
    ...
    [self setBackgroundImage:[UIColor createImageWithColor:[UIColor colorWithRed:57/255.0 green:180/255.0 blue:211/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)warningStyle{
    ...
    [self setBackgroundImage:[UIColor createImageWithColor:[UIColor colorWithRed:237/255.0 green:155/255.0 blue:67/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)dangerStyle{
    ...
    [self setBackgroundImage:[UIColor createImageWithColor:[UIColor colorWithRed:210/255.0 green:48/255.0 blue:51/255.0 alpha:1]] forState:UIControlStateHighlighted];
}

- (void)addAwesomeIcon:(FAIcon)icon beforeTitle:(BOOL)before
{
    NSString *iconString = [NSString stringFromAwesomeIcon:icon];
    self.titleLabel.font = [UIFont fontWithName:@"ArialMT"
